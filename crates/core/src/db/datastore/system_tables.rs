...
pub fn st_table_schema() -> TableSchema {
    TableSchema {
        ...
        columns: [
            ColumnSchema {
                table_id: ST_TABLES_ID.0,
                col_id: ColId(StTableFields::TableId as u32),
            ...
            ColumnSchema {
                table_id: ST_TABLES_ID.0,
                col_id: ColId(StTableFields::TableName as u32),
            ...
            ColumnSchema {
                table_id: ST_TABLES_ID.0,
                col_id: ColId(StTableFields::TableType as u32),
            ...
            ColumnSchema {
                table_id: ST_TABLES_ID.0,
                col_id: ColId(StTableFields::TablesAccess as u32),
...
pub fn st_columns_schema() -> TableSchema {
    TableSchema {
        ...
        columns: [
            ...
            ColumnSchema {
                table_id: ST_COLUMNS_ID.0,
                col_id: ColId(StColumnFields::ColId as u32),
            ...
            ColumnSchema {
                table_id: ST_COLUMNS_ID.0,
                col_id: ColId(StColumnFields::ColType as u32),
            ...
            ColumnSchema {
                table_id: ST_COLUMNS_ID.0,
                col_id: ColId(StColumnFields::ColName as u32),
            ...
            ColumnSchema {
                table_id: ST_COLUMNS_ID.0,
                col_id: ColId(StColumnFields::IsAutoInc as u32),
...
pub(crate) fn st_constraints_schema() -> TableSchema {
    TableSchema {
        ...
        columns: [
            ColumnSchema {
                table_id: ST_CONSTRAINTS_ID.0,
                col_id: ColId(StConstraintFields::ConstraintId as u32),
            ...
            ColumnSchema {
                table_id: ST_CONSTRAINTS_ID.0,
                col_id: ColId(StConstraintFields::ConstraintName as u32),
            ...
            ColumnSchema {
                table_id: ST_CONSTRAINTS_ID.0,
                col_id: ColId(StConstraintFields::Kind as u32),
            ...
            ColumnSchema {
                table_id: ST_CONSTRAINTS_ID.0,
                col_id: ColId(StConstraintFields::TableId as u32),
            ...
            ColumnSchema {
                table_id: ST_CONSTRAINTS_ID.0,
                col_id: ColId(StConstraintFields::Columns as u32),
...
pub(crate) fn st_module_schema() -> TableSchema {
    TableSchema {
        ...
        columns: [
            ColumnSchema {
                table_id: ST_MODULE_ID.0,
                col_id: ColId(StModuleFields::ProgramHash as u32),
                col_name: string(StModuleFields::ProgramHash.name()),
                col_type: AlgebraicType::array(AlgebraicType::U8),
                is_autoinc: false,
            },
            ColumnSchema {
                table_id: ST_MODULE_ID.0,
                col_id: ColId(StModuleFields::Kind as u32),
                col_name: string(StModuleFields::Kind.name()),
                col_type: AlgebraicType::U8,
                is_autoinc: false,
            },
            ColumnSchema {
                table_id: ST_MODULE_ID.0,
                col_id: ColId(StModuleFields::Epoch as u32),
                col_name: string(StModuleFields::Epoch.name()),
...
impl<N: Into<SatsString>> From<StIndexRow<N>> for ProductValue {
    fn from(x: StIndexRow<N>) -> Self {
        product![
            x.index_id,
            x.table_id,
            ArrayValue::from(x.cols.map(|x| x.0)),
