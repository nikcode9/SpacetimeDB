...
use super::datastore::traits::{IndexDef, IndexId, TableDef, TableSchema};
...
fn schema_updates(
    existing_tables: Vec<TableSchema>,
    proposed_tables: Vec<TableDef>,
    system_logger: &mut SystemLogger,
    ...
    let mut known_tables: BTreeMap<String, TableSchema> = existing_tables
        .into_iter()
